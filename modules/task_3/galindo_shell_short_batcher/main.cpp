...
#include <iostream>
#include <vector>
#include "../../../modules/task_3/galindo_shell_short_batcher/galindo_shell_short_batcher.h"
#include <gtest-mpi-listener.hpp>

TEST(Parallel_Shell_Sort_Batcher_MPI, Size_10) {
    int rank;
...
TEST(Parallel_Shell_Sort_Batcher_MPI, Size_15) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
...
TEST(Parallel_Shell_Sort_Batcher_MPI, Size_100) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
...
TEST(Parallel_Shell_Sort_Batcher_MPI, Size_500) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
...
TEST(Parallel_Shell_Sort_Batcher_MPI, Size_1000) {
    int rank;
    MPI_Comm_rank(MPI_COMM_WORLD, &rank);
