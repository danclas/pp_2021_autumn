...
#ifndef MODULES_TASK_3_GHANGA_B_OPERATOR_SOBEL_OPERATOR_SOBEL_H_
#define MODULES_TASK_3_GHANGA_B_OPERATOR_SOBEL_OPERATOR_SOBEL_H_
#include <vector>
...
#endif  // MODULES_TASK_3_GHANGA_B_OPERATOR_SOBEL_OPERATOR_SOBEL_H_
