...
#ifndef MODULES_TASK_3_KURGUZIKOV_SIMPSON_METHOD_KURGUZIKOV_SIMPSON_METHOD_H_
#define MODULES_TASK_3_KURGUZIKOV_SIMPSON_METHOD_KURGUZIKOV_SIMPSON_METHOD_H_
#include <vector>
#include <algorithm>
#include <utility>
